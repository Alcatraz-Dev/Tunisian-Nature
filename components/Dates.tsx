...
const gallery = [
  ...
  { src: "/images/datespalm.png", alt: "Golden Tunisian Dates on palm" },
  { src: "/images/date.png", alt: "Dates in traditional basket" },
  { src: "/images/dattes-1.png", alt: "Dates in traditional basket" },
  { src: "/images/degletNour.png", alt: "Close-up of premium dates" },
];
      ...
      <div className="screen-max-width px-5 sm:px-10">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="text-lg text-stone-300 mb-6">
                Harvested from the golden palm oases of the Sahara, our dates are naturally sweet and packed with essential nutrients. Grown in the harsh desert environment that gives them their unique flavor profile.
              </p>

              {/* Features */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                {[
                  ["Sun-dried", "Naturally dried under the sun"],
                  ["Rich in fiber", "Good for digestion and energy"],
                  ["High in potassium", "Supports heart and muscles"],
                  ["Sustainably harvested", "Respecting nature and local farmers"],
                ].map(([title, desc]) => (
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <span className="px-3 py-1 rounded-full bg-amber-900/40 text-amber-200 text-sm">Sun-Dried</span>
                <span className="px-3 py-1 rounded-full bg-amber-900/40 text-amber-200 text-sm">Natural</span>
              </div>
            </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-black/25 p-6 rounded-xl">
            ...
            <p className="text-stone-300 text-sm">Family-owned farms, traditional harvesting, and artisanal drying methods.</p>
          </div>

          <div className="bg-black/25 p-6 rounded-xl">
            <h4 className="text-amber-300 font-semibold mb-2">Sustainability</h4>
            <p className="text-stone-300 text-sm">Eco-friendly farming, solar-powered drying, and fair compensation for workers.</p>
          </div>
